      ...
      <div class="panels-container">
        <div class="panel left-panel">
          <div class="panel-content">
            <h3>New here ?</h3>
            <p>
              In everyone's heart, there is a person who can not remember, but can
              not embrace and cherish.
            </p>
            <button class="panel-btn" @click="toSignUp">Sign up</button>
          </div>
          <img class="panel-img" src="@/assets/img/log.png" alt="" />
        </div>
        <div class="panel right-panel">
          ...
          <img class="panel-img" src="@/assets/img/register.png" alt="" />
        </div>
      </div>
  
      <div class="forms-container">
        <div class="sign-in-up">
          <form v-on:submit.prevent class="sign-in-form">
          ...
          <form v-on:submit.prevent class="sign-up-form">
        ...
        this.$axios({
          ...
          .then((res) => {
            ...
            if (res.data.success === true && res.status === 200) {
              ...
              return this.$message.error(res.data.detail);
            }
          })
          .catch((error) => {
            // console.log(error);
